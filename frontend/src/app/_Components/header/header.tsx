        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-right hidden sm:block">
              ...
              <div className="text-xs" style={{ color: "hsl(var(--text-disabled))" }}>
                Premium Member
              </div>
            </div>
          ...
          {showProfileMenu && (
            ...
            >
              ...
              <div className="p-2">
                {[
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.backgroundColor = "hsl(var(--action-hover))"
                    }}
                    onMouseLeave={(e) => {
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      <div className="text-sm font-medium" style={{ color: "hsl(var(--text-primary))" }}>
                        {item.label}
                      </div>
                      <div className="text-xs" style={{ color: "hsl(var(--text-disabled))" }}>
                        {item.desc}
              ...
              {/* Logout */}
              <div className="border-t p-2" style={{ borderColor: "hsl(var(--divider))" }}>
                <button
